...
datamap_t* entity_t::GetPredDescMap()
{
	...
	return call_virtual< Fn >(this, csgo.indexes.at(16))(this);
}
...
void entity_t::set_model_index(int index)
{
	...
	return call_virtual<Fn>(this, csgo.indexes.at(7))(this, index);
}
...
//	return call_virtual<Fn>(this, csgo.indexes.at(8))(this);
//}
...
bool player_t::setup_local_bones(int matrix)
{
	...
	*(unsigned short*)(uintptr_t(this) + 0x68) |= 2;
	...
	float time = (this != csgo.local() ? m_flSimulationTime() : TICKS_TO_TIME(m_clientstate()->m_iServerTick));
...
float weapon_t::get_spread_virtual()
{
	if (!this) //-V704
		return 0.0f;
	//return engineprediction::get().GetSpread();
	return call_virtual<float(__thiscall*)(void*)>(this, csgo.indexes.at(10))(this);
}
...
float weapon_t::get_inaccuracy_virtual()
{
	if (!this) //-V704
		return 0.0f;
	//return engineprediction::get().GetInaccuracy();
	return call_virtual<float(__thiscall*)(void*)>(this, csgo.indexes.at(9))(this);
}
...
void weapon_t::update_accuracy_penality()
{
	...
	call_virtual<void(__thiscall*)(void*)>(this, csgo.indexes.at(11))(this);
}
...
bool weapon_t::can_fire(bool check_revolver)
{
	...
	if (owner == csgo.local() && antiaim::get().freeze_check)
		return false;
	...
	auto server_time = TICKS_TO_TIME(csgo.globals.fixed_tickbase);
...
bool weapon_t::is_autosniper()
{
	...
	return weapon_id == WEAPON_SCAR20 || weapon_id == WEAPON_G3SG1;
}

bool weapon_t::is_singlesniper()
{
	if (!this) //-V704
		return false;
	...
	return weapon_id == WEAPON_AWP || weapon_id == WEAPON_SSG08;
}
...
void player_t::modify_eye_position(Vector& eye_position)
{
	...
	auto head_position = Vector(csgo.globals.prediction_matrix[head_bone][0][3], csgo.globals.prediction_matrix[head_bone][1][3], csgo.globals.prediction_matrix[head_bone][2][3] + 1.7f);
...
void player_t::update_clientside_animation()
{
	...
	call_virtual<Fn>(this, csgo.indexes.at(13))(this);
}
...
Vector player_t::get_eye_pos()
{
	static auto Weapon_ShootPosition = reinterpret_cast<float* (__thiscall*)(void*, Vector*)>(
		util::FindSignature(crypt_str("client.dll"), crypt_str("55 8B EC 56 8B 75 08 57 8B F9 56 8B 07 FF 90 ? ? ? ?"))
		);
...
bool player_t::valid(bool check_team, bool check_dormant)
{
	...
	if (check_team && csgo.local()->m_iTeamNum() == m_iTeamNum())
		return false;
...
void viewmodel_t::SendViewModelMatchingSequence(int sequence)
{
	...
	call_virtual <Fn>(this, csgo.indexes.at(14))(this, sequence);
}
...
void CHudChat::chat_print(const char* fmt, ...)
{
	...
	call_virtual <void(__cdecl*)(void*, int, int, const char*, ...)>(this, csgo.indexes.at(15))(this, 0, 0, fmt);
	va_end(args);
}