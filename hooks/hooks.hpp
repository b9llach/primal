...
namespace hooks
{
	...
	extern vmthook* oCParticleCollection_Simulate;
	...
	extern DWORD original_particlecollection;
	...
	extern DWORD original_ispaused;

	void __fastcall hooked_particlecollection_simulate(CParticleCollection* thisPtr, void* edx);
	...
	bool __fastcall hooked_is_paused(void* ecx, void* edx);
