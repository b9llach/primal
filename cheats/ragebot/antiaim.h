...
public:
	...
	bool CanAntiAim(CUserCmd* m_pcmd, bool extra_check);
	...
	bool Auto_FreeStand_key = false;

	float UpPitchExploit(CUserCmd* m_pcmd);
	float randomyaw(CUserCmd* m_pcmd);
	float The_silence_of_the_Buryats(CUserCmd* m_pcmd);
