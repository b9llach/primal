...
namespace math
{
	...
	void VectorAngles3(const Vector& forward, Vector& angles, Vector* up)
	{
		Vector  left;
	...
	float abs_angle(float angle) {
		return angle + 180; // high-tier math right here
	}
	...
	matrix3x4_t angle_matrix1(const matrix3x4_t& matrix, ang_t& angles)
	{
		matrix3x4_t result;
