...
DWORD WINAPI main(PVOID base)
{
	...
	base_address = base;
	AllocConsole();
	SetConsoleTitleA("primal - bootstrapper");
	...
	std::cout << crypt_str("1. Setupping sounds\n");
	Sleep(150);
	setup_sounds();
	std::cout << crypt_str("2. Setupping skins\n");
	Sleep(150);
	setup_skins();
	std::cout << crypt_str("3. Setupping netvars\n");
	Sleep(150);
	setup_netvars();
	std::cout << crypt_str("4. Setupping render\n");
	Sleep(150);
	setup_render();
	std::cout << crypt_str("5. Setupping cfg system\n");
	Sleep(150);
	cfg_manager->setup();
	std::cout << crypt_str("6. Setupping keybind system\n");
	Sleep(150);
	key_binds::get().initialize_key_binds();
	std::cout << crypt_str("7. Setupping vmt hooks\n");
	Sleep(150);
	setup_hooks();
	std::cout << crypt_str("8. Loading netvars\n");
	Sleep(150);
	Netvars::Netvars();
	std::cout << crypt_str("9. Setupping steam api\n");
	Sleep(150);
	setup_steam();
	std::cout << crypt_str("10. Setupping Discord RPC\n");
	Sleep(150);
	discord_main();
	//Render::get().Initialize();
	SetConsoleTitleA("primal - free hvh cheat");
